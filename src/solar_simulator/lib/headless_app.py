"""Solar Simulator Headless Application."""
...
class SolarSimulatorHeadlessApp:
    """Headless application class for the Solar Simulator."""

    def __init__(self, sim: Sim) -> None:
        """Initialize Solar Simulator Headless App."""
        self.sim = sim
        self.data = usb_cdc.data

    def run(self) -> None:
        """Run the main loop for Solar Simulator Headless App."""
