# Demo designed by Romilly Cocking (see https://blog.rareschool.com/2021/01/controlling-raspberry-pi-pico-using.html )
#
# A simple blinky example using pyserial, this script runs on the rp2 pico
